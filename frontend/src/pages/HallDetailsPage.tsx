              ...
              <div className="flex gap-2 overflow-x-auto pb-1">
                {images.map((img, idx) => (
                  <button
                    ...
                    className={`w-20 h-14 rounded overflow-hidden border flex-shrink-0 transition cursor-pointer ${
                      idx === activeImgIdx ? "border-navy-900" : "border-navy-200 opacity-70 hover:opacity-100"
                    }`}
                  >
