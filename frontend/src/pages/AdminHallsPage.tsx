...
export default function AdminHallsPage({
  ...
  const upcomingVenueCount = venueBookings.filter(b => (b.date || b.eventDate || '') >= todayStr).length;
  const pastVenueCount = venueBookings.filter(b => (b.date || b.eventDate || '') < todayStr).length;
  ...
  const filteredVenueBookings = venueBookings.filter(b => {
    ...
    if (logFilterStatus === "Upcoming") {
      return (b.date || b.eventDate || '') >= todayStr;
    }
              ...
              <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-3 bg-navy-50/50">
                {filteredVenueBookings.length === 0 ? (
                  ...
                  filteredVenueBookings.map(b => {
                    const isUpcoming = (b.date || b.eventDate || '') >= todayStr;
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between pt-1">
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-sm font-black text-navy-950">RWF {Number(b.amount || b.totalAmount || 0).toLocaleString()}</span>
